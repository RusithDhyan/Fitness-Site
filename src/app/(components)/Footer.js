...
export default function Footer() {
  return (
    <div className="w-full">
      <div className="w-full px-2 flex flex-col lg:flex-row gap-10 items-center lg:items-center justify-between">
        ...
        <div className="flex flex-col items-center gap-4 text-center text-sm sm:text-base">
          <div>
            ...
            <div className="flex items-center justify-center gap-2 mt-2">
              ...
              <span className="text-[#817e7e]">ucp2020538@gmail.com </span>
            </div>
            <div className="flex items-center justify-center gap-2 mt-2">
              <Phone width={20} height={20} color="#817e7e" />
              <span className="text-[#817e7e]">0710815221</span>
            </div>
          </div>
          <div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-2 my-3 w-full max-w-xs">
            ...
            />
            <button className="bg-black text-white p-2 w-full sm:w-auto rounded-md sm:rounded-none">
              Submit
            </button>
          </div>
        </div>
